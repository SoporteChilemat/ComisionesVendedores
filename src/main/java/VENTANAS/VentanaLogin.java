...
import static DAO.consultaUsuarioDAO.consultaUsuario;
import static VENTANAS.VentanaPrincipal.vl;
...
public class VentanaLogin extends javax.swing.JDialog {
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        dialogLogin = new VentanaUsuario(VentanaPrincipal.ventanaPrincipal, true);
        dialogLogin.setLocationRelativeTo(VentanaPrincipal.ventanaPrincipal);
    ...
    public static void login() {
        try {
            ...
            Boolean consultaUsuario = consultaUsuario(nombre, contraseña);
            if (consultaUsuario) {
                vl.dispose();
//                VentanaPrincipal.cargar();                
            } else {
                JOptionPane.showMessageDialog(VentanaPrincipal.ventanaPrincipal, "Usuario y/o Contraseña incorrectos", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
